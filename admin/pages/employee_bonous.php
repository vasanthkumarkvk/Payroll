                ...
                <div class="content-wrapper">
                    <div class="container">
                        <div id="new-advance" class="tab-content active">
                            ...
                            <form action="bonous_add.php" method="POST" class="advance-salary-form">
                                ...
                                <div class="form-group">
                                    <label for="amount">Bonous Amount</label>
                                    <input type="number" id="amount" name="bonous_amount" placeholder="Enter amount" required>
                                </div>
                                <div class="form-group">
                                    <label for="advance_date">Which Month</label>
                                    <input type="date" id="advance_date" name="bonous_date" required>
                                </div>
                                <div class="form-group">
