            ...
            <div class="navbar-menu-wrapper d-flex align-items-top">
                <ul class="navbar-nav">
                    <li class="nav-item fw-semibold d-none d-lg-block ms-0">
                        <h1 class="welcome-text text-black fw-bold">Pay Contractors</h1>
                    </li>
                </ul>
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#contractor-payment" aria-expanded="false"
                            ...
                            <i class="menu-icon mdi mdi-account-cash"></i> <!-- Account cash icon -->
                            <span class="menu-title">Pay Contractor</span>
                            <i class="menu-arrow"></i> <!-- Optional arrow icon for dropdown -->
                        </a>
                        <div class="collapse" id="contractor-payment">
                            <ul class="nav flex-column ms-3"> <!-- Indented sub-menu -->
                                <li class="nav-item">
