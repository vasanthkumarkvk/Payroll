            ...
            <div class="navbar-menu-wrapper d-flex align-items-top">
                <ul class="navbar-nav">
                    <li class="nav-item fw-semibold d-none d-lg-block ms-0">
                        <h1 class="welcome-text text-black fw-bold">Loans</h1>
                    </li>
                </ul>
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="container">
                        <h2>Loan Request Table</h2>
                        <!-- Buttons at the top-right of the table -->
                        <div class="btn-container">
                            <button onclick="window.location.href='add_loan.php'"><i class="fas fa-plus"></i>Add New
                                Loan</button>
                            <button onclick="window.location.href='pending_loan_view.php'">Pending Loans</button>
                        </div>
                            ...
                            <tbody>
                                <?php if (!empty($employees)): ?>
                                    <?php foreach ($employees as $employee): ?>
                                        ...
                                        <tr>
                                            <td data-label="EMPLOYEE ID"><?php echo htmlspecialchars($employee['employee_id']); ?>
                                            <td data-label="NAME">Jane Smith</td>
                                            <td data-label="LOAN AMOUNT (₹)">100000</td>
                                            <td data-label="OUTSTANDING AMOUNT (₹)">70000</td>
                                            <td data-label="EMI AMOUNT (₹)">10000</td>
                                            <td data-label="REMAINING EMI TERMS">24</td>
                                            <td data-label="LOAN NAME">Home Loan</td>
