                                            ...
                                            <tbody>
                                                ...
                                                if ($result && $result->num_rows > 0) {
                                                    while ($row = $result->fetch_assoc()) {
                                                        ...
                                                        echo "<tr>";
                                                        echo "<td>" . htmlspecialchars($row['employee_user_id']) . "</td>"; // Display Employee ID
                                                        ...
                                                        echo "<td><button type='button' class='view-btn' onclick='redirectToPaySlip(" .
                                                            ...
                                                            json_encode($row['pay_month']) . ", " . // Previous parameters
                                                            json_encode($row['employee_user_id']) . ")'>Update Salary </button></td>";
            ...
            fetch('check_mail.php', {
                ...
                .then(data => {
                    if (data.found) {
                        ...
                        let url = `view_payslip.php?gross=${grossSalary}&email=${encodeURIComponent(email)}&pay_month=${encodeURIComponent(payMonth)}&user_id=${encodeURIComponent(id)}`;
