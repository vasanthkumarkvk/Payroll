            ...
            <div class="navbar-menu-wrapper d-flex align-items-top">
                <ul class="navbar-nav">
                    <li class="nav-item fw-semibold d-none d-lg-block ms-0">
                        <h1 class="welcome-text text-black fw-bold">Employee Reimbursements</h1>
                    </li>
                </ul>
                ...
                <div class="container">
                    ...
                    <form action="#" method="POST" class="reimbursement-form">
                        <div class="form-group">
                            <label for="reimbursement-employee-id">Employee ID</label>
                            <input type="text" id="reimbursement-employee-id" name="reimbursement-employee-id"
                                placeholder="Enter Employee ID" required>
                        </div>
                        <div class="form-group">
                            <label for="reimbursement-employee-name">Employee Name</label>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="net-amount" name="net-amount" placeholder="Final amount after tax">
                        </div>
                        <div class="form-group">
